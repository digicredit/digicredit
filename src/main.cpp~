...
const string strMessageMagic = "digicredit Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // digicredit: 1 days
static const int64 nTargetSpacing = 120; // digicredit: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal digicredit miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "digicredit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x21adea3e8b05b36f7213854bf8e9dff18b80b45714cc0645572610b055d59f3b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 08/Apr/2015 Royal Dutch Shell to Buy BG Group for Nearly $70 Billion";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1428491091; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1428491091;
            block.nNonce   = 193574;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xcc2d05553755d7503d22d20b2bc592d51e428fc17cde61b7cc77789618f341d8"));
